...
namespace RPGCharacterAnims
{
    ...
    public class RPGCharacterMovementController:SuperStateMachineAsset
    {
        //Components.
        ...
        /*void Update () {
		 * Update is normally run once on every frame update. We won't be using it in this case, since the SuperCharacterController component sends a callback Update called SuperUpdate. SuperUpdate is recieved by the SuperPlayerStateMachine, and then fires further callbacks depending on the state
		}*/
