...
namespace Animation
{
    public class WeaponAnimator : MonoBehaviour
    {
        ...
        private void Start()
        {
            WeaponSlotEventManager.EquipLeftHandWeapon += LeftSlotSetAnimation;
            WeaponSlotEventManager.UnequippedLeftHandWeapon += DeleteLeftSlotAnimation;

            WeaponSlotEventManager.EquipRightHandWeapon += RightSlotSetAnimation;
            WeaponSlotEventManager.UnequippedRightHandWeapon += DeleteRightSlotAnimation;
            SetUnarmedAnimation();
        }
