...
{
    [SerializeField] private UnityEvent<IInventoryItemInfo, IInventorySlot> _doubleClicked;
    ...
    private IEnumerator DoubleClickDetection(IInventoryItemInfo itemInfo, IInventorySlot slot)
    {
